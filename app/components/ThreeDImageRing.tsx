...
export interface ThreeDImageRingProps {
  ...
  width?: number;
  /** Auto rotation speed (degrees per frame). 0 disables autoplay */
autoRotateSpeed?: number;
  ...
  /** Enable step-based auto carousel */
autoPlay?: boolean;
/** Pause duration at center (ms) */
pauseDuration?: number;
/** Rotation animation duration (seconds) */
stepDuration?: number;
